    ...
    if (user.roles.includes("Admin")) {
      return (
        <>
          ...
          <button
            onClick={() => handleClick(PATH_DASHBOARD.lectureList)}
            className="flex items-center gap-3 text-gray-300 hover:bg-blue-800 p-3 rounded-lg w-full transition"
          >
            <MdOutlineMedicalServices className="text-orange-400 w-6 h-6" />
            <span className="font-medium text-sm">Lectures</span>
          </button>

          <button
            onClick={() => handleClick(PATH_DASHBOARD.lecturerList)}
            className="flex items-center gap-3 text-gray-300 hover:bg-blue-800 p-3 rounded-lg w-full transition"
          >
            <MdOutlineMedicalServices className="text-orange-400 w-6 h-6" />
            <span className="font-medium text-sm">Lecturers</span>
          </button>
